    ...
    return (
      <div>
        ...
        <p>
          ...
          populate. As you can see in the source code below, I used the
          <code>tblfm</code> directive to fill the first column with an
          ascending counter based on the advice of
          <a href="https://emacs.stackexchange.com/questions/14681/org-mode-table-row-number-grow-automatically">
